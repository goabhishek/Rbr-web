        ...
        <Flex {...flexMiddleContainerStyle}>
          ...
          >
            <Button
              ...
              border='none'
              width='50%'
              backgroundColor={postSorting === 'trending' ? useColorModeValue('purple.100', 'gray.800') : 'none'}
            ...
            <Button
              ...
              border='none'
              width='50%'
              backgroundColor={postSorting === 'latest' ? useColorModeValue('purple.100', 'gray.800') : 'none'}
