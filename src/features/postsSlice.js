...
export const getPosts = createAsyncThunk('/posts/getAllPosts', async (_, { rejectWithValue }) => {
  try {
...
export const getPagedPosts = createAsyncThunk('/posts/getPagedPosts', async ({ pageNum, rejectWithValue }) => {
  try {
...
export const addPost = createAsyncThunk('/posts/addPost', async ({ postData, authToken }, { rejectWithValue }) => {
  try {
...
export const editPost = createAsyncThunk('/posts/editPost', async ({ postData, authToken }, { rejectWithValue }) => {
  try {
...
export const deletePost = createAsyncThunk('/posts/deletePost', async ({ postId, authToken }, { rejectWithValue }) => {
  try {
...
export const likePost = createAsyncThunk('/posts/likePost', async ({ postId, authToken }, { rejectWithValue }) => {
  try {
...
export const addComment = createAsyncThunk(
  ...
  async ({ postId, commentData, authToken }, { rejectWithValue }) => {
    try {
      const response = await addCommentToPostInServer(postId, commentData, authToken);
      return response.data.posts;
    } catch (error) {
      console.error(error.response.data);
